...
const SideChatInfo = ()=>{
    ...
    return(
        <div id="sideChatInfo" style={activeSide_style}>
            ...
            <div className="sideChatInfoOptions" onClick={removeChat}>
                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" enableBackground="new 0 0 24 24" xmlSpace="preserve">
                    <path fill="currentColor" d="M6,18c0,1.1,0.9,2,2,2h8c1.1,0,2-0.9,2-2V6H6V18z M19,3h-3.5l-1-1h-5l-1,1H5v2h14V3z"></path>
                </svg>
                Eliminar Chat
            </div>
        </div>
